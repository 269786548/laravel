    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                <li class="layui-nav-item" lay-unselect>
                    <a lay-href="<?php echo e(route('admin.message.mine')); ?>" layadmin-event="message" lay-text="消息中心">
                ...
                <li class="layui-nav-item" lay-unselect>
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <hr>
                        <dd  style="text-align: center;"><a href="<?php echo e(route('admin.logout')); ?>">退出</a></dd>
                    </dl>
                </li>
                    ...
                    <li data-name="home" class="layui-nav-item layui-nav-itemed">
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="console" class="layui-this">
                                <a lay-href="<?php echo e(route('admin.index')); ?>">控制台</a>
                            </dd>
                            <dd data-name="console">
                                <a lay-href="<?php echo e(route('admin.index1')); ?>">主页一</a>
                            </dd>
                            <dd data-name="console">
                                <a lay-href="<?php echo e(route('admin.index2')); ?>">主页二</a>
                            </dd>
                        </dl>
                    </li>
