...
function http_curl($url,$method='POST',$params='',$headers=''){
    //初始化CURL句柄
    $curl = curl_init();
    ...
    // $headers['listenrobot-client-id'] = 'be3433c0dda14427ab2651b5f5d8cc66';
    // $headers['Authorization'] = 'femfglhddgheljjidd:0f086f016a5b482abb6fd19ffa962f3f';
    if(!empty($headers)){
