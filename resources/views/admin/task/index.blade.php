    ...
    <div class="layui-card">
        <div class="layui-card-header layuiadmin-card-header-auto">
            <div class="layui-btn-group ">
                ...
                @can('task.task.destroy')
                    <button class="layui-btn layui-btn-sm layui-btn-danger" id="listDelete">删除</button>
                @endcan
                @can('task.task.create')
                    <a class="layui-btn layui-btn-sm" href="{{ route('admin.task.create') }}">添加</a>
                @endcan
            </div>
                    ...
                    if(layEvent === 'del'){
                        ...
                        layer.confirm('确认开启吗？', function(index){
                           $.ajax({
                            ...
                            // $.post("{{ route('admin.task.taskSt') }}",{id:[data.task_id],status:1},function (result) {
                            //     layer.close(index);
                            //     layer.msg(result.msg);
                            //     if (result.code==0){
                        ...
                        layer.confirm('确认停止吗？', function(index){
                           $.ajax({
                            ...
                            // $.post("{{ route('admin.task.taskSt') }}",{id:[data.task_id],status:2},function (result) {
                            //     layer.close(index);
                            //     layer.msg(result.msg);
                            //     if (result.code==0){
